...
from lmpipeline.utils.dataset_utils import DatasetFormatter, InstructionDataset
...
def test_format_detection():
    ...
    for format_name, data in test_datasets.items():
        ...
        try:
            ...
            converted_sample = DatasetFormatter.convert_to_standard_format(
...
def test_dataset_integration():
    ...
    dataset = InstructionDataset(
        data=test_data, tokenizer=tokenizer, max_length=512, auto_detect_format=True
    )
