...
def run_basic_training():
    ...
    cmd = [
        ...
        "lmpipeline",
        "--config",
        "configs/sft_only_config.yaml",
        "--model_name_or_path",
        "microsoft/DialoGPT-small",
        "--output_dir",
        "./outputs/basic_training",
    ]
...
def run_llama_training():
    ...
    cmd = [
        ...
        "./data/custom_instructions.jsonl",
        "--output_dir",
        "./outputs/llama_training",
        "--num_train_epochs",
        "3",
...
def run_resume_training():
    ...
    cmd = [
        ...
        "tatsu-lab/alpaca",
        "--output_dir",
        "./outputs/resumed_training",
        "--resume_from_checkpoint",
        "./outputs/basic_training/checkpoint-500",
        "--num_train_epochs",
        "5",
        "--per_device_train_batch_size",
        "2",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--example",
        type=str,
        choices=["basic", "llama", "mistral", "resume"],
        default="basic",
