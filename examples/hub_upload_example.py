...
def example_basic_training_with_hub_upload():
    ...
    cmd = [
        ...
        "--output_dir", "./outputs/basic_training_hub",
        "--num_train_epochs", "1",
        ...
        # Hub upload options
        "--push_to_hub",
        "--hub_repo_id", "your-username/dialogpt-small-alpaca",  # Change this!
    ...
    print("Make sure you have HF_TOKEN environment variable set or run 'huggingface-cli login' first.")
...
def example_lora_adapter_only_upload():
    ...
    cmd = [
        ...
        "--dataset_name_or_path", "tatsu-lab/alpaca",
        "--output_dir", "./outputs/llama_lora_adapters",
        "--num_train_epochs", "2",
        ...
        "--push_to_hub",
        "--hub_repo_id", "your-username/llama-7b-alpaca-lora",  # Change this!
        "--hub_commit_message", "LoRA adapters for Llama-7B fine-tuned on Alpaca",
...
def main():
    ...
    print("in the SFT trainer. The examples show different scenarios and configurations.")
    print()
