...
ALPACA_FORMAT_DATA = [
    ...
    },
    {
        ...
        "input": "",
        "output": "AI (Artificial Intelligence) is the broader concept of machines being able to carry out tasks in a smart way, while ML (Machine Learning) is a subset of AI that focuses on the idea that machines can learn from data.",
    },
]
...
PROMPT_COMPLETION_DATA = [
    {
        ...
        "completion": "Artificial intelligence (AI) refers to the simulation of human intelligence in machines that are programmed to think and learn like humans.",
    },
    {
        "prompt": "What are the main types of machine learning?",
        "completion": "The main types of machine learning are supervised learning, unsupervised learning, and reinforcement learning.",
    },
    {
        "prompt": "Explain deep learning",
        "completion": "Deep learning is a subset of machine learning that uses neural networks with multiple layers to model and understand complex patterns in data.",
    },
]
...
QA_FORMAT_DATA = [
    ...
    },
    {
        ...
        "answer": "Unsupervised learning finds hidden patterns in data without labeled examples, using techniques like clustering and dimensionality reduction.",
    },
    {
        "question": "What is reinforcement learning?",
        "answer": "Reinforcement learning is a type of machine learning where an agent learns to make decisions by taking actions in an environment and receiving rewards or penalties.",
    },
]
...
CONVERSATIONAL_DATA = [
    ...
    },
    {
        "messages": [
            ...
            {
                "role": "assistant",
                "content": "Computer vision is a field of AI that trains computers to interpret and understand visual information from the world, such as images and videos.",
            },
        ]
    },
    {
        "messages": [
            ...
            {
                "role": "assistant",
                "content": "While automation follows pre-programmed rules to perform tasks, AI can adapt and learn from data to make intelligent decisions in new situations.",
            },
        ]
    },
]
...
"""
    ...
    print(
        "The auto_detect_format flag is enabled by default, so the system will automatically"
    )
    print(
        "detect and convert your dataset format to the standard instruction-response format."
    )
...
def main():
    ...
    try:
        ...
        print("\n=== Summary ===")
        print(
            "This example demonstrates how LMPipeline can automatically handle different dataset formats:"
        )
